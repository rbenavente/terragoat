...
resource aws_iam_role "iam_for_eks" {
  ...
  tags = {
    yor_trace = "0dd88751-719f-447c-aa03-ac73dfbeba8c"
  }
}
...
resource aws_vpc "eks_vpc" {
  ...
  tags = {
    ...
    yor_trace = "518cc90a-7e9b-4c1a-b972-8eb79cb387f9"
  }
}
...
resource aws_subnet "eks_subnet1" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/$${local.eks_name.value}" = "shared"
    yor_trace                                        = "2935b606-556e-4fdb-93ec-891de145069c"
  }
}
...
resource aws_subnet "eks_subnet2" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/${local.eks_name.value}"  = "shared"
    "kubernetes.io/cluster/$${local.eks_name.value}" = "shared"
    yor_trace                                        = "f4927b8b-22c0-43c9-be20-17535a829846"
  }
}
...
resource aws_eks_cluster "eks_cluster" {
  ...
  tags = {
    yor_trace = "eca2de7b-ef55-4013-a5b1-ed161ab1ea0c"
  }
}
